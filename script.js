...
var arr = [
    { "Name": "Sentiment Analysis of Hotel Reviews using Deep Learning", "Link": "https://github.com/kxnxchukwu/DMML2Project", 'Description': '(Team of three) performed a sentiment analysis on Trip Advisor Reviews dataset. The project focused on using two Deep Learning models (LSTM and BERT) to predict the hotel’s rating using it’s reviews.', 'Tech': 'Python | Pandas | NumPy | scikit-learn | seaborn | matplotlib | TensorFlow | PyTorch | Keras | GloVe embedding | transformers'},
    { "Name": "Analysis on the Relationship between Population Growth Rate, Life Expectancy and the Gross National Income", "Link": "https://github.com/kxnxchukwu/DAPProject", 'Description': '(Team of three) analyzed three public datasets from ArcGIS Hub & Datahub. The objective of the project was to demonstrate the team’s knowledge of data wrangling (transforming data from one form to another) and Relational (PostgreSQL) & NoSQL (MongoDB) databases.', 'Tech': 'Python | Pandas | Numpy | requests | pymongo | zipfile | psycopg2 | sqlalchemy | matplotlib | seaborn | plotly.express | statsmodels'},
    { "Name": "Exploring Student Academic Performance in Portugal using Machine Learning", "Link": "https://github.com/kxnxchukwu/DAPAProject", 'Description': 'Built a C5.0 Decision Tree Model to predict student academic performance.', 'Tech': 'R | R Studio | C50 | printr | data.table'},
    { "Name": "London Underground High-Speed Line Simulation and Optimization", "Link": "https://github.com/kxnxchukwu/MSOProject", 'Description': 'The project involved discrete event simulation and optimization. The project modelled, simulated and optimized the London Old Oak Commons to Birmingham Interchange section of the London Underground high-speed line.', 'Tech': 'Python | SimPy | Pandas | Numpy | mathplotlib | Google Colab'},
  ];
